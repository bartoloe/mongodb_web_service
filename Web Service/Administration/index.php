...
<li class ="menuhaut">
<a class="home" href="#">Membres</a>
</li>
<li class ="menuhaut">
<a class="workexperience" href="#">Catégories</a>
</li>
<li class ="menuhaut">
...
<form action="getAllMembres.php" method="get">

<p class="contenutext">
<label for="Username" class="contenutext">Search by email : <input type="email" name="emailuser" /></label><br /><br />
