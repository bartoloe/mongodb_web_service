...
foreach ($response as $document) {
	foreach($document['sujet'] as $sujet){
	//var_dump($sujet);
?>
<tr>
<td><label for="<?= $sujet['_idsujet']["\$id"]; ?>" class="contenutext">Id Sujet : </label></td>
<td><input type="text" id="<?= $sujet['_idsujet']["\$id"]; ?>" value="<?= $sujet['_idsujet']["\$id"]; ?>"><br /><br /></td> 
</tr>
<tr>
<td><label for="<?= $sujet['categorie']; ?>" class="contenutext">Catégorie : </label></td>
<td><input type="text" id="<?= $sujet['categorie']; ?>" value="<?= $sujet['categorie']; ?>"><br /><br /></td> 
</tr>
<tr>
<td><label for="<?= $sujet['contenu']; ?>" class="contenutext">Contenu : </label></td>
<td><input type="text" id="<?= $sujet['contenu']; ?>" value="<?= $sujet['contenu']; ?>"><br /><br /></td> 
</tr>
<tr>
<td><label for="<?= date('d-m-Y h:i:s', $sujet['date']['sec']); ?>" class="contenutext">Date : </label></td>
<td><input type="text" id="<?= date('d-m-Y h:i:s', $sujet['date']['sec']); ?>" value="<?= date('d-m-Y h:i:s', $sujet['date']['sec']); ?>"><br /><br /></td> 
</tr>
<?php
}
}
